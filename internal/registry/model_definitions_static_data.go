...
func GetOpenAIModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			Description:         "GPT 5.3 Codex fixed at medium reasoning effort.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
		...
		},
		{
			...
			Description:         "GPT 5.3 Codex fixed at high reasoning effort.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
		...
		},
		{
			...
			Description:         "GPT 5.3 Codex fixed at xhigh reasoning effort.",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"xhigh"}},
		},
		{
