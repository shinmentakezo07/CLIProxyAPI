...
// AntigravityExecutorRefactored proxies requests to the antigravity upstream.
type AntigravityExecutorRefactored struct {
	cfg *config.Config
}

// NewAntigravityExecutorRefactored creates a new Antigravity executor instance.
//
// Parameters:
//   - cfg: The application configuration
//
// Returns:
//   - *AntigravityExecutorRefactored: A new Antigravity executor instance
func NewAntigravityExecutorRefactored(cfg *config.Config) *AntigravityExecutorRefactored {
	return &AntigravityExecutorRefactored{cfg: cfg}
}

// Identifier returns the executor identifier.
func (e *AntigravityExecutorRefactored) Identifier() string { return antigravityAuthType }

// PrepareRequest injects Antigravity credentials into the outgoing HTTP request.
func (e *AntigravityExecutorRefactored) PrepareRequest(req *http.Request, auth *cliproxyauth.Auth) error {
	if req == nil {
		return nil
	}
...
func (e *AntigravityExecutorRefactored) HttpRequest(ctx context.Context, auth *cliproxyauth.Auth, req *http.Request) (*http.Response, error) {
	if req == nil {
...
func (e *AntigravityExecutorRefactored) Execute(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
...
func (e *AntigravityExecutorRefactored) executeClaudeNonStream(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	baseModel := thinking.ParseSuffix(req.Model).ModelName
...
func (e *AntigravityExecutorRefactored) convertStreamToNonStream(stream []byte) []byte {
	responseTemplate := ""
	var traceID string
...
func (e *AntigravityExecutorRefactored) ExecuteStream(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (_ *cliproxyexecutor.StreamResult, err error) {
	if opts.Alt == "responses/compact" {
...
func (e *AntigravityExecutorRefactored) Refresh(ctx context.Context, auth *cliproxyauth.Auth) (*cliproxyauth.Auth, error) {
	if auth == nil {
		return auth, nil
	}
...
func (e *AntigravityExecutorRefactored) CountTokens(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (cliproxyexecutor.Response, error) {
	baseModel := thinking.ParseSuffix(req.Model).ModelName
...
// FetchAntigravityModelsRefactored retrieves available models using the supplied auth.
func FetchAntigravityModelsRefactored(ctx context.Context, auth *cliproxyauth.Auth, cfg *config.Config) []*registry.ModelInfo {
	exec := &AntigravityExecutorRefactored{cfg: cfg}
...
func (e *AntigravityExecutorRefactored) ensureAccessToken(ctx context.Context, auth *cliproxyauth.Auth) (string, *cliproxyauth.Auth, error) {
	if auth == nil {
...
func (e *AntigravityExecutorRefactored) refreshToken(ctx context.Context, auth *cliproxyauth.Auth) (*cliproxyauth.Auth, error) {
	if auth == nil {
		return nil, statusErr{code: http.StatusUnauthorized, msg: "missing auth"}
	}
...
func (e *AntigravityExecutorRefactored) ensureAntigravityProjectID(ctx context.Context, auth *cliproxyauth.Auth, accessToken string) error {
	if auth == nil {
		return nil
	}
...
func (e *AntigravityExecutorRefactored) buildRequest(ctx context.Context, auth *cliproxyauth.Auth, token, modelName string, payload []byte, stream bool, alt, baseURL string) (*http.Request, error) {
	if token == "" {
